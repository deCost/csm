...
namespace CSM
{
    public partial class Settings : System.Web.UI.Page
    {
        ...
        protected void btnProfile_Click(object sender, EventArgs e)
        {
            ...
            {
                //Script register to show exception info
				ClientScript.RegisterStartupScript(this.GetType(), "showMsg", string.Format(@"jsAlert('{0}');", string.Format(ex.Message,user.UserLogin)));
        ...
        protected void btnRule_Click(object sender, EventArgs e)
        {
            ...
            {
                //Script register to show exception info
                ClientScript.RegisterStartupScript(this.GetType(), "showMsg", string.Format(@"jsAlert('{0}');", string.Format(ex.Message, user.UserLogin)), true);
                lblprofilemsg.Text = ex.Message;
                return;
            }
            catch (Exception ex)
